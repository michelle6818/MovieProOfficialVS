...
namespace MovieProOfficial.Controllers
{
    public class StudiosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Location,FoundedDate,BoxOfficeRevenue,StudioId")] Studio studio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Location,FoundedDate,BoxOfficeRevenue,StudioId")] Studio studio)
        {
            if (id != studio.Id)
            {
                return NotFound();
